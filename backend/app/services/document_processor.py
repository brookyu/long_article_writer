...
class DocumentProcessingPipeline:
    ...
    async def process_document(
        ...
        try:
            ...
            for i, (chunk, embedding) in enumerate(valid_chunks_and_embeddings):
                chunk_data = {
                    "chunk_id": f"{document_id}_{chunk.chunk_index}",  # Temporary ID
    ...
    async def search_similar_content(
        ...
        try:
            ...
            query_embedding = await ollama_client.generate_embedding(query_text, embedding_model)
            ...
            results = await vector_store.search_similar(
                collection_id, query_embedding, limit, score_threshold
            )
